...
describe('Given Register component and render it', () => {
    ...
    describe('When the component has been render', () => {
        test('Then it should display the title', () => {
            const title = /usuario/i;
            const element = screen.getByText(title);
            expect(element).toBeInTheDocument();
        });
        test('Then it should display a form with 3 inputs and a button', () => {
    ...
    describe('When the user type in the inputs', () => {
        ...
        test('Then typed text in third input should be in the screen', async () => {
            const mockTyped = 'Test email';
